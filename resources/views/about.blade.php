...
<section class="flex flex-col pb-4">
    <div
        ...
        <div class="flex relative flex-col items-center mb-0 w-full max-w-[1203px] max-md:mb-2.5 max-md:max-w-full">
            ...
            <p class="self-stretch mt-14 text-lg text-center max-md:mt-10 max-md:max-w-full">
                <br /><br />
                Hasanuddin University International Class was established as part of UNHASvision to become a
    ...
    <div
        ...
        <article class="w-1/2 max-md:w-full">
            ...
            ready to compete in the global market, while leveraging the potential of the Indonesian Maritime Continent.
            </p>
        </article>
        <article class="w-1/2 max-md:w-full">
...
<section class="flex flex-col pb-12 bg-neutral-50">
