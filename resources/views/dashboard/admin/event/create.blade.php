            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.event.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="Publication_Date" class="block mt-1 w-full" type="date" name="Publication_Date" :value="old('Publication_Date')" required autocomplete="Publication_Date" />
