    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <!-- Form to Edit Event -->
                <form method="POST" action="{{ route('admin.news.update', $news->ID_News) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div>
                        ...
                        <x-text-input id="News_Title" class="block mt-1 w-full" type="text" name="News_Title" :value="old('News_Title', $news->News_Title)" required autofocus autocomplete="News_Title" />
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="News_Content" name="News_Content" class="block mt-1 w-full" rows="4" required>{{ old('News_Content', $news->News_Content) }}</textarea>
                    ...
                    <div class="mt-4">
                        ...
                        @if($news->News_Image)
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $news->News_Image) }}" alt="Current Image" class="rounded-lg w-[150px] h-[100px] object-cover">
                            </div>
                        @endif
                    </div>
