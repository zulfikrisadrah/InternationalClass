            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.program.update', $program->ID_program) }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="End_Date" class="block mt-1 w-full" type="date" name="End_Date" :value="old('End_Date', $program->End_Date)"  required autocomplete="End_Date" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="Course_Credits" class="block mt-1 w-full" type="number" name="Course_Credits" :value="old('Course_Credits', $program->Course_Credits)" min="1" required autocomplete="Course_Credits" />
