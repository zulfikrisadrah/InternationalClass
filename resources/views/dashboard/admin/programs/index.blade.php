                                ...
                                <div class="overflow-y-auto" style="{{ $isScrollable ? 'max-height: 300px;' : '' }}">
                                    <table class="min-w-full table-auto border-collapse">
                                        <thead class="bg-gray-100">
                                            <tr>
                                                <th class="px-6 py-3 text-left text-sm font-medium text-gray-500 border-b border-gray-300">Student Name</th>
                                                <th class="px-6 py-3 text-left text-sm font-medium text-gray-500 border-b border-gray-300">Status</th>
                                                <th class="px-6 py-3 text-left text-sm font-medium text-gray-500 border-b border-gray-300">Actions</th>
                                            </tr>
                                        </thead>
                                        <tbody>
