<x-app-layout>
    ...
    <div class="container mx-auto p-4">
        ...
        <!-- Dropdown Semester -->
        <div class="mb-4">
            <form method="GET" action="{{ route('student.studyPlan.index') }}">
                <label for="semester" class="mr-2 font-semibold">Pilih Semester:</label>
                <select name="semester" id="semester" class="border px-4 py-2 rounded" style="width: 100px;">
                ...
                <button type="submit" class="ml-2 px-4 py-2 bg-blue-500 text-white rounded">Tampilkan</button>
            </form>            
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            @if(!empty($mataKuliahData))
                <table class="min-w-full table-fixed border-collapse border border-gray-300">
                    <thead>
                        <tr>
                            <td class="border px-4 py-2 font-bold text-left bg-blue-400 text-white w-4">No</td>
                            <td class="border px-4 py-2 font-bold text-left bg-blue-400 text-white w-15">Nama Mata Kuliah</td>
                            <td class="border px-4 py-2 font-bold text-center bg-blue-400 text-white">SKS</td>
                        </tr>
                    </thead>
                    <tbody>
                    ...
                    <tfoot>
                        <tr>
                            <td class="border px-4 py-2 font-bold text-left bg-blue-400 text-white" colspan="2">TOTAL SKS</td>
                            <td class="border px-4 py-2 font-bold text-center bg-blue-400 text-white">
                                @php
